...
from particle_filter import particle_filter_optimization
...
def optimize_prices_for_week(optimizer_caller, ruta_datos, n_productos, n_tiendas, static_params, current_inventory, semana_idx):
    print(f"  Optimizando precios usando filtro de partículas...")
    N_PARTICLES = 10
    precios_base = static_params["precios_base_np"]

    best_prices, best_score = particle_filter_optimization(
    ...
    return best_prices, resultados_detallados
...
def main():
    ...
    for semana_idx_año in range(1, N_SEMANAS_PLANIFICACION + 1):
        ...
        precios_optimos_semana_actual_np, resultados_detallados_semana = optimize_prices_for_week(
