...
# --- Simular ---
q_t1, o_t1, precios_t1, ingresos_t1 = simular_base_stock_con_precio(demanda_t1_4sem, stock_base_t1, price_avg_t1)
q_t2, o_t2, precios_t2, ingresos_t2 = simular_base_stock_con_precio(demanda_t2_4sem, stock_base_t2, price_avg_t2)
